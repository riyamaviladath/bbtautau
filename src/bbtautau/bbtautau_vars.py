...
HLT_2022 = {
    ...
    "PFJet": ["HLT_AK8PFJet420_MassSD30", "HLT_AK8PFJet425_SoftDropMass40"],
    ...
    # These are in Muon
    "MuonTau": ["HLT_IsoMu20_eta2p1_LooseDeepTauPFTauHPS27_eta2p1_CrossL1"],
    "EGamma": [
    ...
    # This is in EGamma
    "ETau": ["HLT_Ele24_eta2p1_WPTight_Gsf_LooseDeepTauPFTauHPS30_eta2p1_CrossL1"],
...
HLT_dict["data"]["2022"]["PFJet"].remove("HLT_AK8PFJet420_MassSD30")
HLT_dict["signal"]["2022"]["PFJet"].remove("HLT_AK8PFJet420_MassSD30")
...
HLT_dict["signal"]["2023"]["PNet"].remove("HLT_AK8PFJet250_SoftDropMass40_PFAK8ParticleNetBB0p35")
HLT_dict["signal"]["2023"]["PNet"].remove(
    "HLT_AK8PFJet230_SoftDropMass40_PFAK8ParticleNetTauTau0p30"
)
HLT_dict["signal"]["2023"]["QuadJet"].remove("HLT_QuadPFJet70_50_40_35_PNet2BTagMean0p65")
...
HLT_dict["signal"]["2023BPix"]["PNet"].remove(
    "HLT_AK8PFJet250_SoftDropMass40_PFAK8ParticleNetBB0p35"
)
HLT_dict["signal"]["2023BPix"]["PNet"].remove(
    "HLT_AK8PFJet230_SoftDropMass40_PFAK8ParticleNetTauTau0p30"
)
HLT_dict["signal"]["2023BPix"]["QuadJet"].remove("HLT_QuadPFJet70_50_40_35_PNet2BTagMean0p65")
...
HLT_egammas = {
    c: {
        year: [hlt for key in ["EGamma", "ETau"] for hlt in HLT_dict[c][year][key]]
        for year in years
    }
    for c in cat
}
HLT_muons = {
    c: {
        year: [hlt for key in ["Muon", "MuonTau"] for hlt in HLT_dict[c][year][key]]
        for year in years
    }
    for c in cat
}
